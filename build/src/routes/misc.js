var APIResult, Blacklist, Config, FRIENDSHIP_AGREED, Friendship, Group, GroupMember, Session, User, Utility, _, express, jsonfile, path, ref, rongCloud, router, semver, sequelize;
...
router.get('/latest_update', function(req, res, next) {
  var clientVersion, err, squirrelConfig;
